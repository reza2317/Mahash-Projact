  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label={`تغییر حالت به ${resolvedTheme === 'dark' ? 'روشن' : 'تاریک'}`}
      >
        {resolvedTheme === 'dark' ? (
          <Sun className="w-5 h-5 mb-0.5 text-amber-400 animate-spin-slow" />
        ) : (
          <Moon className="w-5 h-5 mb-0.5 text-slate-700" />
        )}
