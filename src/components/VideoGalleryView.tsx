              ...
              >
                ...
                >
                  {video.posterSrc ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-tr from-slate-950 via-indigo-950/40 to-slate-900 flex items-center justify-center">
                      <Film className="w-12 h-12 text-slate-700 group-hover:text-indigo-400 group-hover:scale-110 transition-all duration-300" />
                    </div>
                  )}
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-2">
                    <h3 
                      className="font-bold text-base text-slate-100 group-hover:text-indigo-300 transition-colors line-clamp-1 cursor-pointer"
                      onClick={() => handlePlayVideo(video, video.teamSlug || 'team-thinker')}
                    >
                      {video.title}
                    </h3>
                  ...
                  <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
                    <div className="flex items-center gap-3">
                      <span className="flex items-center gap-1" title="تعداد مشاهده">
