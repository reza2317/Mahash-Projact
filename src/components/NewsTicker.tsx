      ...
      <div className="max-w-7xl mx-auto flex items-center h-10 px-3">
        ...
        <div className="flex-shrink-0 flex items-center gap-2 z-10">
          ...
          <button
            ...
            aria-label={isPaused ? 'ادامه حرکت نوار' : 'توقف موقت نوار'}
          >
            {isPaused ? <Play className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" /> : <Pause className="w-3.5 h-3.5" />}
          </button>
        </div>
